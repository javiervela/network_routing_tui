...
This metric is still not perfect, an error in one routing table can cause a lot of messages to be lost and make the error measurement increase by a lot. We argue that it is a good metric for real world scenarios. 
