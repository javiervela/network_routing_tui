...
\begin{itemize}
    ...
    \item An analysis of the performance of the algorithms.
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{../images/infinity.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{../images/infinity_legacy.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{../images/devious.png}
